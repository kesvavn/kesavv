...
const handleLoadMore = () => {
  ...
  <div className="melodia-blog-container">
    ...
    <h1 className="melodia-blog-subtitle">
      OUR BLOGS & ARTICLES
    </h1>

    <h2 className="melodia-blog-heading">
      Stories by Melodia Event Management
    </h2> <br/>

    <p className="melodia-blog-description">
      On this official Melodia Event Management website, we offer a diverse range of blogs and stories covering various topics related to event management in Kerala. From destination event planning to corporate events, each blog provides valuable insights to help you plan your next event seamlessly.
    </p><br />
